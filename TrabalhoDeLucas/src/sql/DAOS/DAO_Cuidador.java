...
public class DAO_Cuidador {
    public static String instrucao_select = "SELECT * FROM UsuarioCuidador;";
    public static String instrucao_insert = "INSERT INTO UsuarioCuidador(TipoContrato, Cpf, NomePerfil, DescricaoEspecialidades, periodo, senhaCuidador) VALUES (?,?,?,?,?,?);";
    public static String instrucao_delete = "DELETE FROM UsuarioCuidador WHERE IDCuidador = ?;";
        ...
        public static List<UsrCuidador> consultaCuidador(){
            try{
                ...
                while(rs.next()){
                    ...
                    usr.setSenha(rs.getString("senhaCuidador"));
